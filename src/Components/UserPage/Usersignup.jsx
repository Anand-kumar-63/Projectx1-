    ...
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="bg-gray-300 p-6 rounded-lg shadow-lg w-96">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              {...register("username", {
                ...
                minLength: {
                  value: 5,
                  message: "first name should be minimum of 5 character",
                },
                maxLength: {
                  value: 20,
            ...
            {errors.username && (
              <p className="text-blue-500 text-sm">{errors.username.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center items-center">
              <div className="mt-4">
                ...
                className="mt-2 text-sm text-gray-500" type="file" />
                {errors.file && (<p className="text-blue-500 text-sm">{errors.file.message}</p>)}
              </div>
              <div>
                <img
                  className="object-contain bg-blue-400 rounded-full h-16 w-16 mt-3"
                  src=""
                ></img>
              </div>
            </div>
          ...
          <button
            type="submit"
            className="ml-[65px] w-[200px] bg-blue-600 text-white py-2 rounded-2xl hover:bg-blue-700"
          >
            Sign Up
          </button>
        </form>
