...
console.log(title)
  ...
  return (
    <div className="flex text-xl shadow-lg rounded-sm min-w-[800px] max-w-[1400px] h-[350px]  bg-white mx-4 my-2 hover:scale-[1.002] hover:transition-all duration-200">
      <img
      ...
      <div className="ml-4 mt-4 object-contain">
        ...
        {channelimage && (
          ...
          <div className="bg-gray-200 text-sm overflow-hidden h-[40px] w-[800px]">
           {des}
          </div>
