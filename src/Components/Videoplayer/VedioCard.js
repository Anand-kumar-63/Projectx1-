...
const VedioCard = ({ info }) => {
  ...
  return (
    <div className={`text-xs shadow-lg rounded-xl ${!ismenuopen?"w-[390px] h-[280px]":"w-[335px] h-[290px] mx-4"} h-[300px]  bg-gray-800 mx-2 my-2 hover:scale-[1.002] hover:transition-all duration-200`}>
